#!/bin/bash
FILES="VCN_c08 VCN_c09 VCN_c11 VCN_c14 VCN_c16 VCN_c17 VCN_c18 VCN_c19 VCN_c20 VCN_c21 VCN_c22 VCN_29"
model="mGBC"
proto="initIV"
...
do
    echo $f
    python model_run.py ${f} -H -P ${proto} -M ${model} --noparallel &
done
