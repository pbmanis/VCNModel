...
# plots appeared in some posters. This is superseeded by 
# the dataFull and dataNoDend tables below, from later sets of runs
# in this table, cells 2 and 5 have their original reconstructed axons
# whereas in the tables below, they have the "standard" axon as the 
# reconstructions are incomplete. 
