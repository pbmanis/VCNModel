...
"""
******************
NOTE: This version of the file is OBSELETE
The numbers for the synapse area have been updated
******************
"""
...
def printCellInputs(r):
    ...
    print(f"{'Cell ID':>8s}\t{ch:s}")
    for v in list(VCN_Inputs_Clean.keys()):
        t = f"{v:>8s}\t"
        for inp in VCN_Inputs[v][1]:
            t += f"{inp[0]:6.1f}\t"
        print(t)
