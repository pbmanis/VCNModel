...
sizer = OrderedDict([('VCNc09nd', {'pos': [l1, wid, yp[0], ht], 'labelpos': lpos, 'ylabel': 'mV'}),
                    ...
                    ('VCNc19',  {'pos': [l2, wid, yp[0], ht], 'labelpos': lpos, 'ylabel': 'mV'}),
                    ('VCNc20',  {'pos': [l2, wid, yp[1], ht], 'labelpos': lpos, 'ylabel': 'mV'}), 
                    ('VCNc21',  {'pos': [l2, wid, yp[2], ht], 'labelpos': lpos, 'ylabel': 'mV'}),
                    ('VCNc22',  {'pos': [l2, wid, yp[3], ht], 'labelpos': lpos, 'ylabel': 'mV'}),
