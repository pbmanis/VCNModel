"""
Parse a hoc file generated by swc_to_hoc (in the neurovis package), producing the reverse
map from hoc sections back to the swc elements.
This will be done with a "hocx" file, which has the extended information about which swc
