...
basepath = Path('/Users/pbmanis/Desktop/Python/VCNModel')
datafile_default = Path(basepath, 'MorphologyData', 'Dendrite Quality and Surface Areas_comparisons_pbm_14Oct2019_v1.xlsx')
