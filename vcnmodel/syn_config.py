...
VCN_c11 = [ [(94.02), 0., 2., np.nan, np.nan, np.nan, np.nan, 'e'],
...
VCN_c14 = [ [(309.83), 0., 2.,  np.nan, np.nan, np.nan, np.nan, 'e'],
            [(121.64), 0., 2.,  np.nan, np.nan, np.nan, np.nan, 'e'],
            [(150.36), 0., 2., np.nan, np.nan, np.nan, np.nan, 'e'],
            [(19.74), 0., 2.,  np.nan, np.nan, np.nan, np.nan, 'e'],
            [(70.32), 0., 2.,  np.nan, np.nan, np.nan, np.nan, 'e'],
            [(80.39), 0., 2.,  np.nan, np.nan, np.nan, np.nan, 'e'],
            [(83.04), 0., 2.,  np.nan, np.nan, np.nan, np.nan, 'e'],
            [(30.87), 0., 2., np.nan, np.nan, np.nan, np.nan, 'e'],
            ]
